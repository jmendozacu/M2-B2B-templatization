...
namespace Dckap\Topsellingitems\Block\Widget;
 ...
 */
class Topsellingitems extends \Magento\Catalog\Block\Product\AbstractProduct implements BlockInterface, IdentityInterface
{
    protected $_template = 'widget/Topsellingitems.phtml';
    /**
    ...
    public function getTopSellingimages($product)
    {
         $image='category_page_grid'; 
           return $this->imageHelperObj()->init($product, $image)->getUrl();
    }
    /**
     * {@inheritdoc}
