...
class Quote extends \Magento\Framework\App\Action\Action {
    ...
    public function execute() {    
        ...
        $qoProductCollection->addAttributeToSelect(array('name','price','sku','id','type_id','small_image','description'));           
        ...
        foreach ($qoProductCollection as $productObj) {
            ...
            $productData[] = array('label' => $productObj->getName(),'title' => $productObj->getName(),'value' => $productObj->getId(),'sku'   => $productObj->getSKU(),'price' => $productObj->getPrice(),'ptype'  => $productObj->getTypeId(),'pimage' => $pimage,'pdesc' => $productObj->getDescription());
        }
